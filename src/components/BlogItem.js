  ...
  return (
    <Container>
      <Wrapper>
        ...
        <BlogThree>
        <BlogWrapper>
                <Img src='img/blog3-img.jpg' alt='computer monitor setup' />
                <BlogContent>
                     <Day text='Day 3' />
        ...
        <BlogFour>
        <BlogWrapper>
                <Img src='img/blog4-img.jpg' alt='computer monitor setup' />
                <BlogContent>
                     <Day text='Day 4' />
        ...
        <BlogFive>
        <BlogWrapper>
                <Img src='img/blog6-img.webp' alt='computer monitor setup' />
                <BlogContent>
                     <Day text='Day 5' />
